...
def load_data(filename):
    ...
    X = df.iloc[:, 1:-1].values  # Assuming the first column is not a feature and the last column is the target
    y = df.iloc[:, -1].astype(int).values  # Assuming the last column is the target
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------
def main(args):
    X_train, X_test, y_train, y_test = load_data(args.filename)
